        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground flex items-center gap-2">
              <Send className="w-5 h-5 text-primary opacity-60" /> Application Automation & Gating
            </h1>
            <div className="h-3 w-72 bg-muted/60 rounded-md mt-1" />
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="h-9 w-36 bg-card border border-border/80 rounded-xl" />
        </div>
      </div>
