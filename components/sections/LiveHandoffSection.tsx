      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
        ...
        <div className="space-y-6 flex flex-col justify-between">
          ...
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-950/60 border border-slate-800 text-xs font-mono text-cyan-400 backdrop-blur-md">
          ...
          <div className="space-y-3 font-mono">
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/50 border border-slate-800/80 backdrop-blur-xl hover:border-cyan-500/40 transition-colors">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700/60 bg-slate-900/80 text-cyan-400">
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/50 border border-slate-800/80 backdrop-blur-xl hover:border-indigo-500/40 transition-colors">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700/60 bg-slate-900/80 text-indigo-400">
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-950/50 border border-slate-800/80 backdrop-blur-xl hover:border-purple-500/40 transition-colors">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-700/60 bg-slate-900/80 text-purple-400">
          ...
          {/* Live Takeover Card */}
          <div className="p-6 rounded-2xl bg-slate-950/60 border border-cyan-500/40 backdrop-blur-xl flex items-center justify-between gap-4 shadow-lg">
            <div>
              <h4 className="text-xs font-mono font-bold text-white">// PREFER LIVE CHAT?</h4>
              <p className="text-xs text-slate-300 mt-0.5">Request seamless takeover to speak with Sathyanantham in real-time.</p>
            </div>
            <Button
        ...
        {/* Right Form */}
        <div className="p-8 sm:p-10 rounded-3xl bg-slate-950/50 border border-slate-800/80 shadow-2xl backdrop-blur-2xl relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h3 className="text-2xl font-bold text-white tracking-tight mb-6">Send Direct Message</h3>

            {isSubmitted ? (
              <div className="p-8 rounded-2xl bg-emerald-950/40 border border-emerald-800/80 text-center space-y-4 font-mono backdrop-blur-md">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 font-mono">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-3 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors backdrop-blur-sm"
                  />
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1.5">// PROJECT SCOPE / INQUIRY</label>
                  <textarea
                    {...register('notes')}
                    rows={4}
                    placeholder="Details regarding your project, role, or collaboration..."
                    className="w-full bg-slate-900/80 border border-slate-800 rounded-xl p-4 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400 transition-colors backdrop-blur-sm"
                  />
                  {errors.notes && <p className="text-[11px] text-rose-400 mt-1">{errors.notes.message}</p>}
                </div>
