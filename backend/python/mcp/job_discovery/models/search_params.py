...
class JobSearchParams(BaseModel):
    ...
    job_requirements: Optional[str] = Field(default=None, description="JSearch job_requirements e.g. 'under_3_years_experience'")
    radius: Optional[int] = Field(default=None, description="Search radius in kilometers")
    page: int = Field(default=1, ge=1, description="Page number")
    num_pages: int = Field(default=1, ge=1, description="Total pages to fetch")
